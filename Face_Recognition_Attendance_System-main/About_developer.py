...
class About_Developer:
    def __init__(self,root):
        ...
        dev_lbl=Label(main_frame,text="Excuted by grpno3",font=("times new roman",20,"bold"),bg="light blue",fg="black")
        dev_lbl.place(x=0,y=170,width=730,height=50)

        dev1_lbl=Label(main_frame,text="sem 6",font=("times new roman",20,"bold"),bg="light blue",fg="black")
        dev1_lbl.place(x=0,y=220,width=730,height=50)

        dev1_lbl=Label(main_frame,text="Facial recognisation attendance system",font=("times new roman",20,"bold"),bg="light blue",fg="black")
